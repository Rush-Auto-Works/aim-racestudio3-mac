...
TESTS=(unit-validators.sh unit-version.sh unit-net.sh unit-acquire.sh unit-ledger.sh unit-preflight.sh unit-data.sh unit-launcher.sh unit-wine.sh unit-winemac-patch.sh unit-classify-tag.sh unit-pins-online.sh unit-update-pins.sh unit-uninstall-daemon.sh unit-bridge-logpath.sh unit-collect-logs.sh dryrun-test.sh)
fail=0; skip=0
for t in "${TESTS[@]}"; do
  echo "=============================================================="
  echo "RUN $t"
